...
def _advice_for(name: str) -> str:
    mapping = {
        ...
        "diff_log_freshness": "Revisar sidecar IA y permisos de escritura en dynamic_ai_config_diffs.jsonl.",
        "diff_log_json_parse": "Revisar corrupcion del JSONL de diffs y limpiar entradas truncadas.",
        "diff_log_recent_activity": "Validar que el orquestador IA este arriba y ejecutando ciclos.",
        "env_escape_valve": "Confirmar DERIV_BOOM_CRASH_ESCAPE_VALVE=true en runtime.",
        "env_block_boom600": "Confirmar DERIV_BLOCK_BC_ESCAPE_BOOM600=false en .env y runtime.",
        "env_block_boom900": "Confirmar DERIV_BLOCK_BC_ESCAPE_BOOM900=false en .env y runtime.",
