...
SYMBOL_SCORE_CEILING_MAP: dict[str, float] = {
    "BOOM500": float(os.getenv("DYNAMIC_AI_BOOM500_SCORE_CEILING", str(SCORE_MAX_GUARDRAIL)) or SCORE_MAX_GUARDRAIL),
    "BOOM600": float(os.getenv("DYNAMIC_AI_BOOM600_SCORE_CEILING", str(SCORE_MAX_GUARDRAIL)) or SCORE_MAX_GUARDRAIL),
    "CRASH500": float(os.getenv("DYNAMIC_AI_CRASH500_SCORE_CEILING", str(SCORE_MAX_GUARDRAIL)) or SCORE_MAX_GUARDRAIL),
    "CRASH600": float(os.getenv("DYNAMIC_AI_CRASH600_SCORE_CEILING", str(SCORE_MAX_GUARDRAIL)) or SCORE_MAX_GUARDRAIL),
